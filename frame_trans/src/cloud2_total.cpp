...
public:
  ...
  PeriodicSnapshotter()
  {
    ...
    pub_ = n_.advertise<sensor_msgs::PointCloud> ("assembled_cloud2", 1);
  ...
  void timerCallback(const ros::TimerEvent& e)
  {
    ...
    if (client_.call(srv))
    {
      ROS_INFO("Published Cloud2 with %u points", (uint32_t)(srv.response.cloud.points.size())) ;
...
{
  ros::init(argc, argv, "cloud2_periodic_snapshotter");
  ros::NodeHandle n;
